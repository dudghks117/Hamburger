...
namespace Miniproject_Hamburger
{
    public partial class OrderForm : Form
    {
                ...
                while (reader.Read())
                {
                    switch (reader[3].ToString())
                    {
                        ...
                        case "치즈":
                            ...
                            Label_Count_Cheese.Tag = reader[2].ToString();
                        ...
                        case "야채":
                            ...
                            Label_Count_Vege.Tag = reader[2].ToString();
        ...
        {
            int count;
            if (!int.TryParse(countLabel.Tag.ToString(), out count))
                count = 1;
            ...
            using (SqlConnection connection = new SqlConnection(Commons.CONSTRING))
            {
                ...
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        {
                            int amount = int.Parse(reader[1].ToString()) - ingreComsumption[id];
